<x-app-layout>
    ...
    <div id="toast-danger" class="z-50 fixed flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow top-5 right-5 dark:text-gray-400 dark:bg-gray-800" role="alert">
