    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse px-4 lg:px-12">
            <li class="inline-flex items-center">
                <a href="/finance/document_invoice"
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            ...
                            @foreach ($reservations as $reservation)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center">
                                        <button id="{{ $reservation['id'] }}-dropdown-button"
                                            data-dropdown-toggle="{{ $reservation['id'] }}-dropdown"
                                        ...
                                        <div id="{{ $reservation->id }}-dropdown"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $reservation->id }}-dropdown-button">
                                                <li>
                                                    <a href="{{ url('/finance/invoice/pdf/' . $reservation->id) }}"
                                            ...
                                            <form
                                                action="{{ route('reservations.destroy', ['id' => $reservation->id]) }}"
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $reservations->firstItem() }} to
                            {{ $reservations->lastItem() }}</span>
                        of
